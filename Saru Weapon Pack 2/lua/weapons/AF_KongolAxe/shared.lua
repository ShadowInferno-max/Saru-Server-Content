...
SWEP.Primary.Attacks = {
	{
		...
		['snd'] = "weapons/demo_sword_swing_crit.wav", -- Sound ID
		['snd_delay'] = 0,
		["viewpunch"] = Angle(20,10,0), --viewpunch angle
		['end'] = 1.6, --time before next attack
		['hull'] = 40, --Hullsize
		['direction'] = "W", --Swing dir,
		['hitflesh'] = "weapons/blade_slice_2.wav",
		['hitworld'] = "weapons/demo_sword_hit_world2.wav"
	}
}
...
SWEP.BlockSound = "MetalVent.ImpactHard"
