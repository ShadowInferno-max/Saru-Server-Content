...
SWEP.PrintName				= "Colossus Mass Driver"		-- Weapon name (Shown on HUD)	
...
SWEP.TracerName = "tracer_colossus"   -- tracer_colossus
SWEP.TracerCount = 1
...
SWEP.Primary.Sound			= Sound("NPC_Strider.OpenHatch")		-- script that calls the primary fire sound
